...
class Facade extends Base {
  ...
  setupResources() {
    this.config.resources.getAll().forEach(this.setupResource)
    this.config.resources.getAll().forEach(this.setupResourceFields)
  }
  ...
  setupStates() {
    this.config.states.getAll().forEach(this.setupState)
  }
  ...
  setupComponentsToHide() {
    this.config.components.getAll().forEach(this.setupComponentToHide)
  }
